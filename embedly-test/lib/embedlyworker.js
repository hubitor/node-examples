...
var EMBEDLY_KEY = 'YOUR API CODE HERE';
var VALID_TYPES = {
  extract: 'extract',
  oembed: 'oembed'
};
...
module.exports = {
  ...
  /**
   * Extracts the specified page(s) contents using the Embed.ly API using either the Embedly `extract()` or `oembed()` API.
   *
   * Usage:
   ...
   *
   * @param {Object|String} optionsOrUrl A URL to a page to scrape, or an object containing a `url` or `urls` (Array) argument.
   * @param {String}   type A String which specifies whether we should use the `extract()` or `oembed()` API. Valid values are 'extract' or 'oembed'.
   * @param {Function} callback A callback function with the following signature: `function (err, results)` where results is an Array of objects from the specified Embed.ly `type` API.
   */
